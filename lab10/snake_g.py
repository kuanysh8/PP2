...
def create_table():
    conn = psycopg2.connect(dbname='mydb', user='postgres', password='240407', host='localhost', port='5432')
    cur = conn.cursor()
    create_table_query = """
...
def game_loop(player_name):
    global score, level, snake_pos, food, food_spawn, paused, snake_speed
